...
public class Status {
    ...
    public Pane showStatus(ArrayList<String> infoStatus){
        ...
        sauver.setOnAction(app.getController().generateEventHandlerAction("update-Status",supplier));

        supplier = () -> new String[] {""};
        afficher.setOnAction(app.getController().generateEventHandlerAction("show-all-status", supplier ));
